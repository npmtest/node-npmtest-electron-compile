...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/sanitize-paths.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/sanitize-paths.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; sanitize-paths.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function cachedRealpath(p) {</span>
<span class="cstat-no" title="statement not covered" >  let ret = realpathCache.get(p);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  ret = _fs2.default.realpathSync(p);</span>
<span class="cstat-no" title="statement not covered" >  d(`Cache miss for cachedRealpath: '${p}' =&gt; '${ret}'`);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  realpathCache.set(p, ret);</span>
 ...
 * @private
 */
<span class="fstat-no" title="function not covered" >function sanitizeFilePath(file) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  let realFile = null;</span>
<span class="cstat-no" title="statement not covered" >  let parts = file.split(/[\\\/]app.asar[\\\/]/);</span>
<span class="cstat-no" title="statement not covered" >  if (!parts[1]) {</span>
    // Not using an ASAR archive
<span class="cstat-no" title="statement not covered" >    realFile = cachedRealpath(file);</span>
  } else {
    // We do all this silliness to work around
    // https://github.com/atom/electron/issues/4610
<span class="cstat-no" title="statement not covered" >    realFile = `${cachedRealpath(parts[0])}/app.asar/${parts[1]}`;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return realFile.replace(/[\\\/]/g, '/');</span>
}
