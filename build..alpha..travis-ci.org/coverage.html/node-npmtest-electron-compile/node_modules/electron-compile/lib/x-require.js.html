...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/x-require.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/x-require.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; x-require.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function requireModule(href) {</span>
<span class="cstat-no" title="statement not covered" >  let filePath = href;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (filePath.match(/^file:/i)) {</span>
<span class="cstat-no" title="statement not covered" >    let theUrl = _url2.default.parse(filePath);</span>
<span class="cstat-no" title="statement not covered" >    filePath = decodeURIComponent(theUrl.pathname);</span>
&nbsp;
...
&nbsp;
exports.default = (() =&gt; {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (process.type !== 'renderer' || <span class="branch-1 cbranch-no" title="branch not covered" >!window </span>|| <span class="branch-2 cbranch-no" title="branch not covered" >!window.document)</span> return null;
&nbsp;
<span class="cstat-no" title="statement not covered" >  let proto = Object.assign(Object.create(HTMLElement.prototype), {</span>
    createdCallback: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      let href = this.getAttribute('src');</span>
<span class="cstat-no" title="statement not covered" >      if (href &amp;&amp; href.length &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >        requireModule(href);</span>
      }
    },
    attributeChangedCallback: <span class="fstat-no" title="function not covered" >function (attrName, oldVal, newVal) {</span>
<span class="cstat-no" title="statement not covered" >      if (attrName !== 'src') <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >      requireModule(newVal);</span>
    }
  });
&nbsp;
<span class="cstat-no" title="statement not covered" >  return document.registerElement('x-require', { prototype: proto });</span>
})();
