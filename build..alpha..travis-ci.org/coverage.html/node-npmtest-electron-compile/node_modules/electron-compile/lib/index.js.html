...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/index.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/index.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; index.js</div>
</div>
<div class="body">
...
module.exports = Object.assign({
  ...
  enableLiveReload: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    enableLiveReload = enableLiveReload || require('./live-reload').enableLiveReload;</span>
<span class="cstat-no" title="statement not covered" >    return enableLiveReload(...arguments);</span>
  },
  watchPath: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    watchPath = watchPath || require('./pathwatcher-rx').watchPath;</span>
<span class="cstat-no" title="statement not covered" >    return watchPath(...arguments);</span>
  }
