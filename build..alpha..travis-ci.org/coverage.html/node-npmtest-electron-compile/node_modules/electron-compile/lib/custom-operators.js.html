...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/custom-operators.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/custom-operators.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; custom-operators.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function retryWithDelayOrError(errors, maxRetries) {</span>
<span class="cstat-no" title="statement not covered" >  return _Observable.Observable.range(1, maxRetries + 1).zip(errors, (i, e) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    return { attempts: i, error: e };</span>
  }).mergeMap((_ref) =&gt; {
<span class="cstat-no" title="statement not covered" >    let attempts = _ref.attempts,</span>
        error = _ref.error;
&nbsp;
<span class="cstat-no" title="statement not covered" >    return attempts &lt;= maxRetries ? _Observable.Observable.timer(attempts * 1000) : _Observable.Observable.throw(error);</span>
  });
}
&nbsp;
const newCoolOperators = {
  guaranteedThrottle: <span class="fstat-no" title="function not covered" >function (time) {</span>
<span class="cstat-no" title="statement not covered" >    let scheduler = arguments.length &gt; 1 &amp;&amp; arguments[1] !== undefined ? arguments[1] : _async.async;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.map(x =&gt; <span class="cstat-no" title="statement not covered" >_Observable.Observable.timer(time, scheduler).map(() =&gt; <span class="cstat-no" title="statement not covered" >x)</span>)</span>.switch();</span>
  },
&nbsp;
  retryAtIntervals: <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >    let maxRetries = arguments.length &gt; 0 &amp;&amp; arguments[0] !== undefined ? arguments[0] : 3;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return this.retryWhen(errors =&gt; <span class="cstat-no" title="statement not covered" >retryWithDelayOrError(errors, maxRetries))</span>;</span>
  }
};
&nbsp;
