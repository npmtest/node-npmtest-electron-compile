...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/digest-for-object.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/digest-for-object.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; digest-for-object.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function updateDigestForJsonValue(shasum, value) {</span>
...
<span class="cstat-no" title="statement not covered" >    shasum.update('"', 'utf8');</span>
<span class="cstat-no" title="statement not covered" >    shasum.update(value, 'utf8');</span>
<span class="cstat-no" title="statement not covered" >    shasum.update('"', 'utf8');</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (type === 'boolean' || type === 'number') {</span>
<span class="cstat-no" title="statement not covered" >    shasum.update(value.toString(), 'utf8');</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!value) {</span>
<span class="cstat-no" title="statement not covered" >    shasum.update('null', 'utf8');</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      updateDigestForJsonValue(shasum, value[i]);</span>
<span class="cstat-no" title="statement not covered" >      shasum.update(',', 'utf8');</span>
    }
<span class="cstat-no" title="statement not covered" >    shasum.update(']', 'utf8');</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
...
<span class="cstat-no" title="statement not covered" >    updateDigestForJsonValue(shasum, keys[i]);</span>
<span class="cstat-no" title="statement not covered" >    shasum.update(': ', 'utf8');</span>
<span class="cstat-no" title="statement not covered" >    updateDigestForJsonValue(shasum, value[keys[i]]);</span>
<span class="cstat-no" title="statement not covered" >    shasum.update(',', 'utf8');</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  shasum.update('}', 'utf8');</span>
 ...
 * @private  
 */
<span class="fstat-no" title="function not covered" >function createDigestForObject(obj) {</span>
<span class="cstat-no" title="statement not covered" >  let sha1 = _crypto2.default.createHash('sha1');</span>
<span class="cstat-no" title="statement not covered" >  updateDigestForJsonValue(sha1, obj);</span>
&nbsp;
