...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/require-hook.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/require-hook.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; require-hook.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  window.__hot = [];</span>
<span class="cstat-no" title="statement not covered" >  electron = require('electron');</span>
<span class="cstat-no" title="statement not covered" >  HMR = electron.remote.getGlobal('__electron_compile_hmr_enabled__');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (HMR) {</span>
<span class="cstat-no" title="statement not covered" >    electron.ipcRenderer.on('__electron-compile__HMR', () =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      d("Got HMR signal!");</span>
&nbsp;
      // Reset the module cache
<span class="cstat-no" title="statement not covered" >      let cache = require('module')._cache;</span>
<span class="cstat-no" title="statement not covered" >      let toEject = Object.keys(cache).filter(x =&gt; <span class="cstat-no" title="statement not covered" >x &amp;&amp; !x.match(/[\\\/](node_modules|.*\.asar)[\\\/]/i))</span>;</span>
<span class="cstat-no" title="statement not covered" >      toEject.forEach(x =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        d(`Removing node module entry for ${x}`);</span>
<span class="cstat-no" title="statement not covered" >        delete cache[x];</span>
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      window.__hot.forEach(fn =&gt; <span class="cstat-no" title="statement not covered" >fn())</span>;</span>
    });
  }
}
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function registerRequireExtension(compilerHost) {</span>
<span class="cstat-no" title="statement not covered" >  if (HMR) {</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      require('module').prototype.hot = {</span>
        accept: cb =&gt; <span class="cstat-no" title="statement not covered" >window.__hot.push(cb)</span>
      };
&nbsp;
<span class="cstat-no" title="statement not covered" >      require.main.require('react-hot-loader/patch');</span>
    } catch (e) {
<span class="cstat-no" title="statement not covered" >      console.error(`Couldn't require react-hot-loader/patch, you need to add react-hot-loader@3 as a dependency! ${e.message}`);</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  Object.keys(compilerHost.compilersByMimeType).forEach(mimeType =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    let ext = _mimeTypes2.default.extension(mimeType);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    require.extensions[`.${ext}`] = (module, filename) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      var _compilerHost$compile = compilerHost.compileSync(filename);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      let code = _compilerHost$compile.code;</span>
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (code === null) {</span>
<span class="cstat-no" title="statement not covered" >        console.error(`null code returned for "${filename}".  Please raise an issue on 'electron-compile' with the contents of this file.`);</span>
      }
&nbsp;
