...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/read-only-compiler.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/read-only-compiler.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; read-only-compiler.js</div>
</div>
<div class="body">
...
class ReadOnlyCompiler {
   ...
   * @private
   */
  constructor<span class="fstat-no" title="function not covered" >(name, compilerVersion, compilerOptions, inputMimeTypes) {</span>
<span class="cstat-no" title="statement not covered" >    Object.assign(this, { name, compilerVersion, compilerOptions, inputMimeTypes });</span>
  }
&nbsp;
  shouldCompileFile<span class="fstat-no" title="function not covered" >() {</span>
...
<span class="cstat-no" title="statement not covered" >      return true;</span>
  ...
  determineDependentFiles<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* () {</span></span>
...
<span class="cstat-no" title="statement not covered" >    return _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* () {</span></span>
<span class="cstat-no" title="statement not covered" >      throw new Error("Read-only compilers can't compile");</span>
    })();
  }
&nbsp;
  shouldCompileFileSync<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return true;</span>
  }
  determineDependentFilesSync<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return [];</span>
  }
&nbsp;
  compileSync<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    throw new Error("Read-only compilers can't compile");</span>
  }
&nbsp;
  getCompilerVersion<span class="fstat-no" title="function not covered" >() {</span>
<span class="cstat-no" title="statement not covered" >    return this.compilerVersion;</span>
  }
}
