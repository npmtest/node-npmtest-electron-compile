...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/protocol-hook.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/protocol-hook.js</span></h1>
    <h2>
        ...
        Lines: <span class="metric">22.22% <small>(26 / 117)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; protocol-hook.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function doesMapFileExist(filePath) {</span>
<span class="cstat-no" title="statement not covered" >  let ret = mapStatCache.get(filePath);</span>
<span class="cstat-no" title="statement not covered" >  if (ret !== undefined) <span class="cstat-no" title="statement not covered" >return Promise.resolve(ret);</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  return new Promise(res =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    _fs2.default.lstat(filePath, (err, s) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      let failed = err || !s;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      mapStatCache.set(filePath, !failed);</span>
<span class="cstat-no" title="statement not covered" >      res(!failed);</span>
    });
  });
}
&nbsp;
 ...
 * @private
 */
<span class="fstat-no" title="function not covered" >function rigHtmlDocumentToInitializeElectronCompile(doc) {</span>
<span class="cstat-no" title="statement not covered" >  let lines = doc.split("\n");</span>
<span class="cstat-no" title="statement not covered" >  let replacement = `&lt;head&gt;&lt;script src="${magicWords}"&gt;&lt;/script&gt;`;</span>
<span class="cstat-no" title="statement not covered" >  let replacedHead = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  for (let i = 0; i &lt; lines.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    if (!lines[i].match(/&lt;head&gt;/i)) <span class="cstat-no" title="statement not covered" >continue;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    lines[i] = lines[i].replace(/&lt;head&gt;/i, replacement);</span>
<span class="cstat-no" title="statement not covered" >    replacedHead = true;</span>
<span class="cstat-no" title="statement not covered" >    break;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!replacedHead) {</span>
<span class="cstat-no" title="statement not covered" >    replacement = `&lt;html$1&gt;&lt;head&gt;&lt;script src="${magicWords}"&gt;&lt;/script&gt;&lt;/head&gt;`;</span>
<span class="cstat-no" title="statement not covered" >    for (let i = 0; i &lt; lines.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >      if (!lines[i].match(/&lt;html/i)) <span class="cstat-no" title="statement not covered" >continue;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      lines[i] = lines[i].replace(/&lt;html([^&gt;]+)&gt;/i, replacement);</span>
<span class="cstat-no" title="statement not covered" >      break;</span>
    }
  }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >function requestFileJob(filePath, finish) {</span>
<span class="cstat-no" title="statement not covered" >  _fs2.default.readFile(filePath, (err, buf) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (err) {</span>
<span class="cstat-no" title="statement not covered" >      if (err.errno === 34) {</span>
<span class="cstat-no" title="statement not covered" >        finish(-6); </span>// net::ERR_FILE_NOT_FOUND
<span class="cstat-no" title="statement not covered" >        return;</span>
      } else {
<span class="cstat-no" title="statement not covered" >        finish(-2); </span>// net::FAILED
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
    }
&nbsp;
 ...
 */
<span class="fstat-no" title="function not covered" >function addBypassChecker(bypassChecker) {</span>
<span class="cstat-no" title="statement not covered" >  bypassCheckers.push(bypassChecker);</span>
}
&nbsp;
/**
 ...
 */
<span class="fstat-no" title="function not covered" >function initializeProtocolHook(compilerHost) {</span>
<span class="cstat-no" title="statement not covered" >  protocol = protocol || require('electron').protocol;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  global[magicGlobalForRootCacheDir] = compilerHost.rootCacheDir;</span>
<span class="cstat-no" title="statement not covered" >  global[magicGlobalForAppRootDir] = compilerHost.appRoot;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  const electronCompileSetupCode = `if (window.require) require('electron-compile/lib/initialize-renderer').initializeRendererProcess(${compilerHost.readOnlyMode});`;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  protocol.interceptBufferProtocol('file', (() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    var _ref = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (request, finish) {</span></span>
<span class="cstat-no" title="statement not covered" >      let uri = _url2.default.parse(request.url);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      d(`Intercepting url ${request.url}`);</span>
<span class="cstat-no" title="statement not covered" >      if (request.url.indexOf(magicWords) &gt; -1) {</span>
<span class="cstat-no" title="statement not covered" >        finish({</span>
...
&nbsp;
      ...
      // let's rewrite it
<span class="cstat-no" title="statement not covered" >      if (uri.host &amp;&amp; uri.host.length &gt; 1) {</span>
        //let newUri = request.url.replace(/^file:/, "https:");
        // TODO: Jump off this bridge later
<span class="cstat-no" title="statement not covered" >        d(`TODO: Found bogus protocol-relative URL, can't fix it up!!`);</span>
<span class="cstat-no" title="statement not covered" >        finish(-2);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      let filePath = decodeURIComponent(uri.pathname);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (filePath.match(/[\/\\](atom|electron).asar/) || filePath.match(/[\/\\](node_modules|bower_components)/)) {</span>
        // NBs on NBs: If we're loading an HTML file from node_modules, we still have
        // to do the HTML document rigging
<span class="cstat-no" title="statement not covered" >        if (filePath.match(/\.html?$/i)) {</span>
<span class="cstat-no" title="statement not covered" >          let riggedContents = null;</span>
<span class="cstat-no" title="statement not covered" >          _fs2.default.readFile(filePath, 'utf8', <span class="fstat-no" title="function not covered" >function (err, contents) {</span></span>
<span class="cstat-no" title="statement not covered" >            if (err) {</span>
<span class="cstat-no" title="statement not covered" >              if (err.errno === 34) {</span>
<span class="cstat-no" title="statement not covered" >                finish(-6); </span>// net::ERR_FILE_NOT_FOUND
<span class="cstat-no" title="statement not covered" >                return;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >            riggedContents = rigHtmlDocumentToInitializeElectronCompile(contents);</span>
<span class="cstat-no" title="statement not covered" >            finish({ data: new Buffer(riggedContents), mimeType: 'text/html' });</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
          });
&nbsp;
<span class="cstat-no" title="statement not covered" >          return;</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        requestFileJob(filePath, finish);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      if (filePath.match(/\.map$/i) &amp;&amp; !(yield doesMapFileExist(filePath))) {</span>
<span class="cstat-no" title="statement not covered" >        finish({ data: new Buffer("", 'utf8'), mimeType: 'text/plain' });</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (const bypassChecker of bypassCheckers) {</span>
<span class="cstat-no" title="statement not covered" >        if (bypassChecker(filePath)) {</span>
<span class="cstat-no" title="statement not covered" >          d('bypassing compilers for:', filePath);</span>
<span class="cstat-no" title="statement not covered" >          requestFileJob(filePath, finish);</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
      }
...
<span class="cstat-no" title="statement not covered" >        let result = yield compilerHost.compile(filePath);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (result.mimeType === 'text/html') {</span>
<span class="cstat-no" title="statement not covered" >          result.code = rigHtmlDocumentToInitializeElectronCompile(result.code);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (result.binaryData || result.code instanceof Buffer) {</span>
<span class="cstat-no" title="statement not covered" >          finish({ data: result.binaryData || result.code, mimeType: result.mimeType });</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        } else {
<span class="cstat-no" title="statement not covered" >          finish({ data: new Buffer(result.code), mimeType: result.mimeType });</span>
<span class="cstat-no" title="statement not covered" >          return;</span>
        }
      } catch (e) {
<span class="cstat-no" title="statement not covered" >        let err = `Failed to compile ${filePath}: ${e.message}\n${e.stack}`;</span>
<span class="cstat-no" title="statement not covered" >        d(err);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (e.errno === 34 /*ENOENT*/) {</span>
<span class="cstat-no" title="statement not covered" >            finish(-6); </span>// net::ERR_FILE_NOT_FOUND
<span class="cstat-no" title="statement not covered" >            return;</span>
          }
&nbsp;
<span class="cstat-no" title="statement not covered" >        finish({ mimeType: 'text/plain', data: new Buffer(err) });</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function (_x, _x2) {</span></span>
