...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/cli.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/cli.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; cli.js</div>
</div>
<div class="body">
...
let main = exports.main = (() =&gt; {
  var _ref = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (appDir, sourceDirs, cacheDir, sourceMapDir) {</span>
<span class="cstat-no" title="statement not covered" >    let compilerHost = null;</span>
<span class="cstat-no" title="statement not covered" >    if (!cacheDir || cacheDir.length &lt; 1) {</span>
<span class="cstat-no" title="statement not covered" >      cacheDir = '.cache';</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    let rootCacheDir = _path2.default.join(appDir, cacheDir);</span>
<span class="cstat-no" title="statement not covered" >    _mkdirp2.default.sync(rootCacheDir);</span>
<span class="cstat-no" title="statement not covered" >    let mapDir = rootCacheDir;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (sourceMapDir) {</span>
<span class="cstat-no" title="statement not covered" >      mapDir = _path2.default.join(appDir, sourceMapDir);</span>
<span class="cstat-no" title="statement not covered" >      d(`specifed separate source map dir at ${mapDir}, creating it`);</span>
<span class="cstat-no" title="statement not covered" >      _mkdirp2.default.sync(mapDir);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (process.env.NODE_ENV !== 'production') {</span>
<span class="cstat-no" title="statement not covered" >      console.log(`Using NODE_ENV = ${process.env.NODE_ENV || 'development'}`);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    d(`main: ${appDir}, ${JSON.stringify(sourceDirs)}`);</span>
<span class="cstat-no" title="statement not covered" >    try {</span>
<span class="cstat-no" title="statement not covered" >      compilerHost = yield (0, _configParser.createCompilerHostFromProjectRoot)(appDir, rootCacheDir, sourceMapDir);</span>
    } catch (e) {
<span class="cstat-no" title="statement not covered" >      console.error(`Couldn't set up compilers: ${e.message}`);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    yield Promise.all(sourceDirs.map(<span class="fstat-no" title="function not covered" >function (dir) {</span></span>
<span class="cstat-no" title="statement not covered" >      return (0, _forAllFiles.forAllFiles)(dir, (() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >        var _ref2 = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (f) {</span></span>
<span class="cstat-no" title="statement not covered" >          try {</span>
<span class="cstat-no" title="statement not covered" >            d(`Starting compilation for ${f}`);</span>
<span class="cstat-no" title="statement not covered" >            yield compilerHost.compile(f);</span>
          } catch (e) {
<span class="cstat-no" title="statement not covered" >            console.error(`Failed to compile file: ${f}`);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    d('Saving out configuration');</span>
<span class="cstat-no" title="statement not covered" >    yield compilerHost.saveConfiguration();</span>
  });
&nbsp;
  return <span class="fstat-no" title="function not covered" >function main(_x, _x2, _x3, _x4) {</span>
...
<span class="cstat-no" title="statement not covered" >  d(e.message || e);</span>
<span class="cstat-no" title="statement not covered" >  d(e.stack || '');</span>
});
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  const argv = yargs.argv;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!argv._ || argv._.length &lt; 1) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  const sourceDirs = argv._;</span>
<span class="cstat-no" title="statement not covered" >  const appDir = argv.a;</span>
<span class="cstat-no" title="statement not covered" >  const cacheDir = argv.c;</span>
<span class="cstat-no" title="statement not covered" >  const sourceMapDir = argv.s;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  main(appDir, sourceDirs, cacheDir, sourceMapDir).then(() =&gt; <span class="cstat-no" title="statement not covered" >process.exit(0))</span>.catch(e =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    console.error(e.message || e);</span>
<span class="cstat-no" title="statement not covered" >    d(e.stack);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    console.error("Compilation failed!\nFor extra information, set the DEBUG environment variable to '*'");</span>
<span class="cstat-no" title="statement not covered" >    process.exit(-1);</span>
  });
}
