...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/pathwatcher-rx.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/pathwatcher-rx.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; pathwatcher-rx.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >function watchPathDirect(directory) {</span>
<span class="cstat-no" title="statement not covered" >  return _Observable.Observable.create(subj =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    let dead = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    const watcher = _fs2.default.watch(directory, {}, (eventType, fileName) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (dead) <span class="cstat-no" title="statement not covered" >return;</span></span>
<span class="cstat-no" title="statement not covered" >      subj.next({ eventType, fileName });</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    watcher.on('error', e =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      dead = true;</span>
<span class="cstat-no" title="statement not covered" >      subj.error(e);</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return new _Subscription.Subscription(() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (!dead) {</span>
...
<span class="fstat-no" title="function not covered" >function watchPath(directory) {</span>
<span class="cstat-no" title="statement not covered" >  let ret = pathCache.get(directory);</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  ret = watchPathDirect(directory).publish().refCount();</span>
<span class="cstat-no" title="statement not covered" >  pathCache.set(directory, ret);</span>
