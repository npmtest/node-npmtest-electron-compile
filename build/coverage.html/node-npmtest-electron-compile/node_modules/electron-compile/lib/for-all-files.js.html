...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/for-all-files.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/for-all-files.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; for-all-files.js</div>
</div>
<div class="body">
 ...
 * @private
 */
<span class="fstat-no" title="function not covered" >function forAllFiles(rootDirectory, func) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  let rec = (() =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    var _ref = _asyncToGenerator(<span class="fstat-no" title="function not covered" >function* (dir) {</span></span>
<span class="cstat-no" title="statement not covered" >      let entries = yield _promise.pfs.readdir(dir);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      for (let name of entries) {</span>
<span class="cstat-no" title="statement not covered" >        let fullName = _path2.default.join(dir, name);</span>
<span class="cstat-no" title="statement not covered" >        let stats = yield _promise.pfs.stat(fullName);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (stats.isDirectory()) {</span>
<span class="cstat-no" title="statement not covered" >          yield rec(fullName);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        if (stats.isFile()) {</span>
<span class="cstat-no" title="statement not covered" >          yield func(fullName, ...args);</span>
        }
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function rec(_x) {</span></span>
<span class="cstat-no" title="statement not covered" >      return _ref.apply(this, arguments);</span>
    };
  })();
&nbsp;
<span class="cstat-no" title="statement not covered" >  return rec(rootDirectory);</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function forAllFilesSync(rootDirectory, func) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >  let rec = dir =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    _fs2.default.readdirSync(dir).forEach(name =&gt; {</span>
<span class="cstat-no" title="statement not covered" >      let fullName = _path2.default.join(dir, name);</span>
<span class="cstat-no" title="statement not covered" >      let stats = _fs2.default.statSync(fullName);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (stats.isDirectory()) {</span>
<span class="cstat-no" title="statement not covered" >        rec(fullName);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (stats.isFile()) {</span>
<span class="cstat-no" title="statement not covered" >        func(fullName, ...args);</span>
<span class="cstat-no" title="statement not covered" >        return;</span>
      }
    });
  };
&nbsp;
<span class="cstat-no" title="statement not covered" >  rec(rootDirectory);</span>
}
