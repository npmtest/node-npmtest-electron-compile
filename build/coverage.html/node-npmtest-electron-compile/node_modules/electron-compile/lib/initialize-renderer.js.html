...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-electron-compile/node_modules/electron-compile/lib/initialize-renderer.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-electron-compile/node_modules/electron-compile/lib/initialize-renderer.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-electron-compile/node_modules/electron-compile/lib/</a> &#187; initialize-renderer.js</div>
</div>
<div class="body">
 ...
 * @private
 */
<span class="fstat-no" title="function not covered" >function initializeRendererProcess(readOnlyMode) {</span>
<span class="cstat-no" title="statement not covered" >  if (rendererInitialized) <span class="cstat-no" title="statement not covered" >return;</span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  let rootCacheDir = require('electron').remote.getGlobal(magicGlobalForRootCacheDir);</span>
<span class="cstat-no" title="statement not covered" >  let appRoot = require('electron').remote.getGlobal(magicGlobalForAppRootDir);</span>
...
&nbsp;
  ...
  // until we're set up
<span class="cstat-no" title="statement not covered" >  if (readOnlyMode) {</span>
<span class="cstat-no" title="statement not covered" >    d(`Setting up electron-compile in precompiled mode with cache dir: ${rootCacheDir}`);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    d(`Setting up electron-compile in development mode with cache dir: ${rootCacheDir}`);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _require = require('./config-parser');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    const createCompilers = _require.createCompilers;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    const compilersByMimeType = createCompilers();</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    compilerHost = _compilerHost2.default.createFromConfigurationSync(rootCacheDir, appRoot, compilersByMimeType);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  require('./x-require');</span>
<span class="cstat-no" title="statement not covered" >  require('./require-hook').default(compilerHost);</span>
